  ...
  return (
    <section style={{ background: "#000", padding: isMobile ? "50px 0 80px" : "70px 0 90px" }}>
      <div style={{
        ...
        {!isMobile && (
          <div style={{ width: "0.5px", background: "var(--gold)", margin: "20px 0", opacity: 0.4 }} />
        )}
        ...
        <div style={{
          ...
          <button
            ...
            style={{
              ...
              color: "var(--gold)", fontFamily: "'Inter', 'Helvetica Neue', Helvetica, Arial, sans-serif", fontWeight: 300, fontSize: 19, letterSpacing: ".02em",
